package com.mj.weather.account.model.http.service;
...
public interface UserService {
    ...
    Observable<UserBean.RspProfilePut> profilePut(@Query("key") String key, @Query("item") String item, @Query("value") String value);
    ...
    Observable<UserBean.RspProfileQuery> profileQuery(@Query("key") String key, @Query("item") String item);
    ...
    Observable<UserBean.RspProfileDel> profileDel(@Query("key") String key, @Query("item") String item);
    ...
    Observable<UserBean.RspDataPut> dataPut(@Query("key") String key, @Query("item") String item, @Query("value") String value);
    ...
    Observable<UserBean.RspDataQuery> dataQuery(@Query("key") String key, @Query("item") String item);
    ...
    Observable<UserBean.RspDataDel> dataDel(@Query("key") String key, @Query("item") String item);
