...
import com.mj.weather.weather.component.DaggerWeatherComponent;
import com.mj.weather.weather.model.dp.entity.User;
import com.mj.weather.weather.module.WeatherViewModule;
import com.mj.weather.weather.presenter.WeatherPresenter;
import com.mj.weather.weather.view.fragment.WeatherFragment;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case 1:
                    ...
                    if (TextUtils.isEmpty(cityName) && mLocation != null) {
    ...
    protected void onDestroy() {
        ...
        //关闭定位服务
        WeatherApplicationLike.getInstance().stopLocationService();
    }
}
